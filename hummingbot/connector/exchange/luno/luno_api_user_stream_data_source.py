...
class LunoAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self, kraken_auth: LunoAuth):
    ...
    async def listen_for_user_stream(self, ev_loop: asyncio.BaseEventLoop, output: asyncio.Queue):
        while True:
            ...
            #     a wait asyncio.sleep(30.0)
            self.logger().info("faking user data")
            if len(self._user_orders) > 0:
                output.put_nowait({
                    "tradeUpdate": {
                        "sequence": 0,
                        ...
                        "takerOrderId": self._user_orders.pop(0),
    ...
    def put_user_order(self, id: str):
        self._user_orders.append(id)
