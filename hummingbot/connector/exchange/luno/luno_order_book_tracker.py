...
class LunoOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self, trading_pairs: List[str]):
        super().__init__(LunoAPIOrderBookDataSource(trading_pairs), trading_pairs)
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            self._data_source = LunoAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
